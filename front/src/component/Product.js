          ...
          <div class="h-100">
            <div class="h-50 row product-desc">
              ...
              <div class="col-md-6 d-flex h-100 product-details">
                ...
                <div class="row">
                  <small class="text-danger col-md-8 col-sm-8 text-small-li bold">
                    {product.inStock} left in stock
                  </small>
                  <div class="col-md-4 col-sm-4 d-flex stars-div">
                    <img alt="product" src="image/star.png" class="star-img" />
                    <p class="stars">
                      {product.rating}
                      <p class="text-secondary star-num">(12)</p>
                    </p>
                  </div>
                  <small class="text-small-li bold">
                    by:{" "}
                ...
                <div class="category">
                  <p class="cat-p text-small-li">Category(s)</p>
            ...
            <div class="row h-50 comments">
              ...
              <div class="row vh-40 suggestions">
                ...
                {suggestedProducts &&
                  suggestedProducts.map((suggestionProsuct) => {
                    return (
